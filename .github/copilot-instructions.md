...
Sempre utilize o padrão [Conventional Commits](https://www.conventionalcommits.org/pt-br/v1.0.0/) ao criar mensagens de commit neste projeto. Isso garante clareza, organização e facilita o rastreamento de mudanças.
